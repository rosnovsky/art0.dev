...
export const MobileSidebar = ({ sidebarOpen, setSidebarOpen, navigation, teams }: { sidebarOpen: boolean, setSidebarOpen: Dispatch<SetStateAction<boolean>>, navigation: any, teams: any }) => {
  return (
